...
public class AppConfig {
	...
	@Bean
	public Table table1Bean(){ return new Table (1,6,TableStatus.AVAILABLE); }

	@Bean
	public Table table2Bean(){ return new Table (2,4,TableStatus.AVAILABLE); }

	@Bean
	public Table table3Bean(){ return new Table (3,2,TableStatus.AVAILABLE); }
